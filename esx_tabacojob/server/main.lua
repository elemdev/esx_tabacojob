...
AddEventHandler('esx_tabacjob:startHarvest', function(zone)
	...
	if PlayersHarvesting[_source] == false then
		TriggerClientEvent('esx:showNotification', _source, '~r~Não é bom de falha. ~w~')
...
AddEventHandler('esx_tabacjob:stopHarvest', function()
	...
	if PlayersHarvesting[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Podes ~g~recolher.')
		PlayersHarvesting[_source]=true
	end
end)
...
AddEventHandler('esx_tabacjob:startTransform', function(zone)
	...
	if PlayersTransforming[_source] == false then
		TriggerClientEvent('esx:showNotification', _source, '~r~Não é bom a falha. ~w~')
...
AddEventHandler('esx_tabacjob:stopTransform', function()
	...
	if PlayersTransforming[_source] == true then
		...
		TriggerClientEvent('esx:showNotification', _source, 'Podes ~g~transformar.')
		PlayersTransforming[_source]=true
